...
export async function deployTokenGeSact20forPermissionSetId(deployer: SignerWithAddress, permissions: Permissions55, permissionSetId: number): Promise<GeSAct20v1> {
    const tokenFactory = await ethers.getContractFactory(
        'GeSAct20v1',
        deployer
    ) as GeSAct20v1__factory;
    ...
    const params: GeSAct20v1.ContractParametersStruct = {
        ...
        transferRestrictions: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    };


    const token = await tokenFactory.connect(deployer)
